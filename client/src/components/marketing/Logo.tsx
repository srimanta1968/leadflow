  ...
  return (
    <Link to={to} className="inline-flex items-center gap-2.5" aria-label="LeadFlow home">
      <svg width="26" height="26" viewBox="0 0 26 26" fill="none" aria-hidden="true">
        <rect width="26" height="26" rx="7" fill="#3d82ff" fillOpacity="0.14" />
        <path d="M6 8h9" stroke="#3d82ff" strokeWidth="2.1" strokeLinecap="round" />
        <path d="M6 13h13" stroke="#00d59a" strokeWidth="2.1" strokeLinecap="round" />
        <path d="M6 18h6" stroke="#9364ff" strokeWidth="2.1" strokeLinecap="round" />
      </svg>
